...
{
    //
    // Code để xem trang chủ product vào website gõ http://localhost/blog/admin/product
    ...
    // Code để xem trang chủ thêm product vào website gõ http://localhost/blog/admin/product/add
    //Code hiển thị các sản phẩm được Thêm
    public function getAddProduct()
    {
        $data['catelist'] = Category::all();
    	return view('backend.addproduct',$data);
    }
    //Code Thêm sản phẩm đó
    ...
    // Code để xem trang chủ chỉnh sửa product vào website gõ http://localhost/blog/admin/product/edit/3
    //Code hiển thị các sản phẩm được sửa
